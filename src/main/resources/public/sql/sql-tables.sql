...
VALUES
    ...
    ('universal 190 mm højre', 'Stk', 0, NULL, NULL, NULL, 'Til montering af spær på rem'),
    ('universal 190 mm venstre', 'Stk', 0, NULL, NULL, NULL, 'Til montering af spær på rem'),
    ('4,5 x 60 mm. skruer', 'Pakke', 0, NULL, NULL, NULL, 'Til montering af stern&vandbrædt'),
    ('4,0 x 50 mm. beslagskruer', 'Pakke', 0, NULL, NULL, NULL, 'Til montering af universalbeslag + hulbånd'),
    ('bræddebolt 10 x 120 mm.', 'Stk', 0, NULL, NULL, NULL, 'Til montering af rem på stolper'),
    ('firkantskiver 40x40x11mm', 'Stk', 0, NULL, NULL, NULL, 'Til montering af rem på stolper'),
    ('4,5 x 70 mm. Skruer', 'Pakke', 0, NULL, NULL, NULL, 'Til montering af yderste beklædning'),
    ('4,5 x 50 mm. Skruer', 'Pakke', 0, NULL, NULL, NULL, 'Til montering af inderste beklædning'),
    ('stalddørsgreb 50x75', 'Sæt', 0, NULL, NULL, NULL, 'Til lås på dør i skur'),
    ('t hængsel 390 mm', 'Stk', 0, NULL, NULL, NULL, 'Til skurdør'),
    ('vinkelbeslag 35', 'Stk', 0, NULL, NULL, NULL, 'Til montering af løsholter i skur');
